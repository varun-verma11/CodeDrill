...
from Views.view_submissions import view_student_submissions, view_submissions_teacher, get_student_submission
...
urlpatterns = patterns('',
    ...
    url(r'^student/view-submissions/get-feedback/(\d+)/$', get_student_submission),
